...
public class IdentityDbContextInitializer
{
    ...
    public IdentityDbContextInitializer(ILogger<IdentityDbContextInitializer> logger, ApplicationUserDbContext context, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager)
    {
        _logger = logger;
        _context = context;
